...
def serializedATN():
    return [
        ...
        17,2,1,0,0,0,18,19,5,43,0,0,19,4,1,0,0,0,20,21,5,42,0,0,21,6,1,0,
        0,0,22,23,5,40,0,0,23,8,1,0,0,0,24,25,5,41,0,0,25,10,1,0,0,0,26,
...
class ToxaLanguageLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "INT", "PLUS", "MULT", "OPEN_PAREN", "CLOSE_PAREN", "WS" ]

    ruleNames = [ "INT", "PLUS", "MULT", "OPEN_PAREN", "CLOSE_PAREN", "WS" ]
